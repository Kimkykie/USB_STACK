 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteTxData0Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteTxData1Reg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadRxData0Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadRxData1Reg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableReceiver(<peripheral>_BASE_PTR, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableTransmitter(<peripheral>_BASE_PTR, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableRxTx(<peripheral>_BASE_PTR, I2S_PDD_RECEIVER);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_DisableRxTx(<peripheral>_BASE_PTR, I2S_PDD_RECEIVER);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableDevice(<peripheral>_BASE_PTR, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteControlReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadControlReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_GetInterruptFlags(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_ClearInterruptFlags(<peripheral>_BASE_PTR,
 *      I2S_PDD_RX_FRAME_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableDmasInterrupts(<peripheral>_BASE_PTR,
 *      I2S_PDD_RX_FRAME_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_DisableDmasInterrupts(<peripheral>_BASE_PTR,
 *      I2S_PDD_RX_FRAME_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteInterruptEnableReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadInterruptEnableReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteTransmitConfigurationReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadTransmitConfigurationReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteReceiveConfigurationReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadReceiveConfigurationReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteTransmitClockControlReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadTransmitClockControlReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteReceiveClockControlReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadReceiveClockControlReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = I2S_PDD_GetRxFIFOCounter1(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = I2S_PDD_GetRxFIFOCounter0(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = I2S_PDD_GetTxFIFOCounter1(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = I2S_PDD_GetTxFIFOCounter0(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetRxFIFOFullWatermark1(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetRxFIFOFullWatermark0(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetTxFIFOFullWatermark1(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetTxFIFOFullWatermark0(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteFIFOControlStatusReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadFIFOControlStatusReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadTxTimeSlotMaskReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadRxTimeSlotMaskReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableAC97Mode(<peripheral>_BASE_PTR, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetAC97Command(<peripheral>_BASE_PTR,
 *      I2S_PDD_AC97_WRITE_COMMAND);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97ControlReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadAC97ControlReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97CommandAddressReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadAC97CommandAddressReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97CommandDataReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadAC97CommandDataReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97TagReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = I2S_PDD_ReadAC97TagReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_EnableAC97Channels(<peripheral>_BASE_PTR,
 *      I2S_PDD_AC97_DATA_SLOT_3);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97ChannelEnableReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_DisableAC97Channels(<peripheral>_BASE_PTR,
 *      I2S_PDD_AC97_DATA_SLOT_3);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_WriteAC97ChannelDisableReg(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_GetAC97ChannelStatusMask(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 *      @code
 *      uint32_t result =
 *      I2S_PDD_ReadAC97ChannelStatusReg(<peripheral>_BASE_PTR);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetClockSource(<peripheral>_BASE_PTR,
 *      I2S_PDD_DIVIDED_CORE_SYSTEM_CLOCK);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetClockDivider(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      I2S_PDD_SetClockMultiplier(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
